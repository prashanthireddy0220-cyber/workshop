...
import { Calendar, MapPin, Clock, Save, CheckCircle2, ShieldAlert } from 'lucide-react';
...
const EventManagement = () => {
    ...
    try {
      ...
      if (res.data.success && res.data.event) {
        ...
        setFormData({
          ...
          registrationFee: ev.registrationFee || formData.registrationFee,
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      setSuccessMsg('Event details & website configuration updated live!');
    ...
    <div>
      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <p style={{ color: '#94A3B8', fontSize: '0.86rem', marginTop: '4px', margin: '4px 0 0 0' }}>
          Configure main workshop event parameters, venue location, capacity, dates, and live website settings.
        </p>
      </div>
